...
export default function ContentHero({ data }: { data: AllHomepage }) {
	return (
								...
								<div className='flex w-full items-center flex-row py-3 justify-between border-t border-b bg-zinc-50/40 backdrop-blur-sm border-zinc-600/10'>
									...
									<div className='flex items-center justify-center flex-col gap-3'>
										...
										<div className='flex gap-1 lg:gap-2 items-center justify-center'>
											<Plus size={20} />
											<NumbersAnimatedHero value={data.status01.value} />
										</div>
									</div>
									<div className='flex items-center justify-center flex-col gap-3'>
										<h2 className='font-bold text-sm text-center lg:text-xl'>
										...
										<div className='flex gap-1 lg:gap-2 items-center justify-center'>
											<Plus size={20} />
											<NumbersAnimatedHero value={data.status02.value} />
										</div>
									</div>
									<div className='flex items-center justify-center flex-col gap-3'>
										<h2 className='font-bold text-sm text-center lg:text-xl'>
										...
										<div className='flex gap-1 lg:gap-2 items-center justify-center'>
											<Plus size={20} />
											<NumbersAnimatedHero value={data.status03.value} />
										</div>
									</div>
								</div>
							</div>
