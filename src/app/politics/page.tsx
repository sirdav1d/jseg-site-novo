				...
				<div className='grid grid-cols-2 gap-10 w-full'>
					<div>
						...
						<p className='prose w-full prose-base'>
							A sua privacidade é importante para nós. É política do Jseg
							Equipamentos respeitar a sua privacidade em relação a qualquer
					...
					<div>
						<h3 className='font-bold text-green-500 text-2xl'>
							Compromisso do Usuário
						</h3>
						<br />
						<p className='prose w-full prose-base'>
							O usuário se compromete a fazer uso adequado dos conteúdos e da
							informação que o Jseg Equipamentos oferece no site e com caráter
						...
						<ul className='prose w-full prose-base'>
							...
							<li>
								...
								(softwares) do Jseg Equipamentos, de seus fornecedores ou
